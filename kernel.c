...
void kernel_main(void){
    ...
    for(;;){
        ...
        terminal_column = 4;
        terminal_writestring_colour("System Time-Stamp:", VGA_COLOUR_BLACK, VGA_COLOUR_WHITE); terminal_putchar(' ');
        terminal_writeint(_timestampedx());
        terminal_writeint(_timestampeax());
        terminal_writestring("                \n    ");
        terminal_writestring_colour("rand():", VGA_COLOUR_BLACK, VGA_COLOUR_WHITE); terminal_putchar(' ');
